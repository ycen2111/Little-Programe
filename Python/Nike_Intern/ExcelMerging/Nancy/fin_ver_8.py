#pack code: pyinstaller --name="ForNancy" --console --onefile --upx-dir="D:\Python\Intern\ExcelMerging_env\Scripts" --icon="D:\Python\Intern\ExcelMerging\Nancy\icons.ico" --distpath="D:\Python\Intern\ExcelMerging\Nancy" D:\Python\Intern\ExcelMerging\Nancy\fin_ver_2.py 
...
if __name__ == "__main__":
    ...
    New.set_key_words(["Pstn ID","Prsn Nm","Pstn Desc","Work Email","Band (CLT Group)","Supv Nm","SuprvsrPstnID","Funcl Area Desc","Lvl2TOSOrgChief","Lvl3TOSOrgChief","Lvl4TOSOrgChief","Lvl5TOSOrgChief","Lvl6TOSOrgChief","Lvl7TOSOrgChief","Lvl8TOSOrgChief","Py Grd Grp Cd","Company","Function1","Function2","Construct","Focus"])
